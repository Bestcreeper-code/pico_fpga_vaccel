module serial_stream_dma_interface #(
    ...
    input  logic [1:0] tx_in,
    output logic [1:0] rx_out,

    input  logic [WORD_BITS-1:0] rx_tx_word,

    
    output logic [1:0] leds,

    output logic data_bus_clk,
    output logic we,
    output logic [WORD_BITS-1:0] data_bus_out,
    output logic [ADDRESS_BUS_SIZE-1:0] addr_bus
);
